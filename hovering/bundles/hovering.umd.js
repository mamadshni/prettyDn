(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('hovering', ['exports', '@angular/core'], factory) :
    (factory((global.hovering = {}),global.ng.core));
     ...
     */
    var HoveringService = /** @class */ (function () {
        function HoveringService() {
        }
        ...
        /** @nocollapse */
        HoveringService.ctorParameters = function () { return []; };
        /** @nocollapse */ HoveringService.ngInjectableDef = i0.defineInjectable({ factory: function HoveringService_Factory() { return new HoveringService(); }, token: HoveringService, providedIn: "root" });
        return HoveringService;
    }());
    ...
    var HoveringCircleComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        HoveringCircleComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 },
                { type: HoveringLineFrom, decorators: [{ type: i0.Attribute, args: ['from',] }] },
                { type: HoveringTextPos, decorators: [{ type: i0.Attribute, args: ['textPos',] }] }
            ];
        };
    ...
    var HoveringTextDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        HoveringTextDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
     ...
     */
    // tslint:disable:directive-selector
    var HoveringIconDirective = /** @class */ (function () {
        function HoveringIconDirective(el) {
            this.el = el;
        ...
        /** @nocollapse */
        HoveringIconDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        return HoveringIconDirective;
    }());
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var HoveringModule = /** @class */ (function () {
        function HoveringModule() {
        }
    ...
    exports.HoveringService = HoveringService;
    exports.HoveringCircleComponent = HoveringCircleComponent;
    exports.HoveringModule = HoveringModule;
    exports.ɵd = HoveringIconDirective;
    exports.ɵe = HoveringTextDirective;
    exports.ɵb = HoveringLineFrom;
    exports.ɵc = HoveringTextPos;
...
//# sourceMappingURL=hovering.umd.js.map