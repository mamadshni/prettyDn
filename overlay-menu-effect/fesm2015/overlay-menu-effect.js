 ...
 */
class OverlayMenuEffectService {
    constructor() {
...
/** @nocollapse */
OverlayMenuEffectService.ctorParameters = () => [];
...
/** @nocollapse */
OverlayMenuDirective.ctorParameters = () => [
    { type: TemplateRef }
];
 ...
 * @return {?}
 */
function overlayTextAnimation(duration = 400) {
...
class OverlayMenuEffectComponent {
    /**
 ...
 */
// tslint:disable:component-selector
class OverlayTextEffectComponent {
    /**
     * @param {?} overlayMenuEffectService
     * @param {?} cd
     */
